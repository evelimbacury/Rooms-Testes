# Rooms
Este projeto é uma solução para a criação de ensalamento dinâmico na universidade, com foco em melhorar a alocação de salas e horários para as disciplinas por meio de uma aplicação web, otimizando o uso dos espaços físicos e melhorando o desempenho acadêmico.

![Tela Inicial](.\Principal\Telas\TelaInicial.png)
## Introdução
